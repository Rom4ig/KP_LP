...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(109, "[Семантическая] Обнаружено невозможное деление на ноль"),
		...
		ERROR_ENTRY(113, "[Cемантическая] Нельзя присваивать значение переменной при объявлении"),
		ERROR_ENTRY(114, "[Семантическая] Несоответствие типов"),
		ERROR_ENTRY(115, "[Семантическая] Имя идентификатора - ключевое слово"),
		...
		ERROR_ENTRY(120, "[Семантическая] INT идентификатор - параметр функций SUBSTR и STRLEN"),
		ERROR_ENTRY(121, "[Семантическая] STR идентификатор - параметр функций DOUBLE"),
		...
		ERROR_ENTRY(125, "[Семантическая] Несоответствие параметров в вызываемой функции" ),
		ERROR_ENTRY(126, "[Семантическая] Отсутствует возвращение из функции"),
		ERROR_ENTRY(127, "[Семантическая] Тип функции и тип возвращаемого значения не совпадают"),
