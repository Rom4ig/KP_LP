...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 6,		//Стартовый символ, дно стека, количество правил	
		Rule(NS('S'), GRB_ERROR_SERIES + 0, 5,   //  Структура программы
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 4, 7,  // возможные конструкции в ф-иях
		...
		Rule(NS('E'), GRB_ERROR_SERIES + 2, 20, // выражения
			...
			Rule::Chain(3, TS('-'), TS('l'), NS('M'), NS('E')),
			Rule::Chain(1, TS('l')),
			...
			Rule::Chain(7, TS('p'), TS('('), TS('e'), TS('('), NS('W'), TS(')'), TS(')')),
